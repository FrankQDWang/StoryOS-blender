...
当前资产版本为 **0.1.3-preview.3**，用户于2026-09-17正式认可为当前保留版本，并授权提交到 `main`、同步远端和清理迭代分支。该版本在A书房基础上统一右三台比例和阅读倾角、均衡间距、拉开蓝书台与书桌之间的留白；书桌和椅子保持位置、尺寸。正面及侧面、开书与通路验收通过。历史标签与旧提交保留；保存完成情况见 [PLAN.md](PLAN.md)，版本约定见 [VERSIONING.md](VERSIONING.md)。
