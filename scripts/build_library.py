...
# Baseline hearth, repaired with continuous masonry rather than separated blocks.
# Position, footprint, wood mantel, candles, logs and room lighting stay at v0.1.
...
metadata={'version':'0.1.1-preview.1','baseVersion':'v0.1.0-baseline','change':'Continuous hearth masonry and arch; baseline layout and interaction restored.','blender':bpy.app.version_string,'room':{'width':9.6,'depth':12,'height':4.6},'slots':[{'index':i,'position':[x,1.25,-y],'yaw':-a} for i,(x,y,a) in enumerate(slots)],'materials':{m.name:list(m.get('runtimeTint',[])) for m in [wood,floor,plaster,stone]},'source':'scripts/build_library.py'}
